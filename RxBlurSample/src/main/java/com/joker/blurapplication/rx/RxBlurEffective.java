...
public class RxBlurEffective {
  ...
  @CheckResult @NonNull
  public static Observable<Bitmap> renderScriptPicassoBlur(@NonNull Context context,
      @DrawableRes int resId, int radius) {
    return Observable.create(new PicassoBlurOnSubscribe(context, resId, radius));
  }

  @CheckResult @NonNull
  public static Observable<GlideDrawable> renderScriptGlideBlur(@NonNull Context context,
      @DrawableRes int resId, int radius) {
  ...
  @CheckResult @NonNull
  public static Observable<Bitmap> fastBlur(@NonNull Context context, @DrawableRes int resId,
      int radius) {
    return Observable.create(new FastBlurOnSubscribe(context, resId, radius))
        .compose(SchedulersCompat.<Bitmap>observeOnMainThread());
  }

  @CheckResult @NonNull
  public static Observable<Bitmap> paintBlur(@NonNull Context context, @DrawableRes int resId,
      int radius) {
    return Observable.create(new PaintBlurOnSubscribe(context, resId, radius))
        .compose(SchedulersCompat.<Bitmap>observeOnMainThread());
  }

  @CheckResult @NonNull
  public static Observable<Bitmap> animatorBlur(@NonNull Context context, @DrawableRes int resId,
      int radius, long duration) {
    return Observable.create(new AnimationBlurOnSubscribe(context, resId, radius, duration))
        .onBackpressureBuffer();
  }

  @CheckResult @NonNull
  public static Observable<Bitmap> bestBlur(@NonNull Context context, @DrawableRes Bitmap bitmap,
      int radius, float desaturateAmount) {
